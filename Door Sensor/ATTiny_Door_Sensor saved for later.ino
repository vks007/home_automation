...
#define ENABLE_PULSE_LENGTH 200//pulse length in ms to be sent on sensor open event , My ESP01 is working with 250mS but for ESP12 I think i need ~ 2000 ms, still trying to solve this
...
/*
  ...
  _delay_ms(10);//let the bits stabalize
